...
public:
	...
	/** Seconds elapsed since activation. UE4 backport helper used when running outside UE5's richer anim update context. */
	UPROPERTY(Transient, BlueprintReadOnly, Category = "Defaults")
	...
	virtual FTransform ProcessRootMotion(const FTransform& InRootMotion, float DeltaSeconds) { return InRootMotion; }
...
public:
	...
	class UCurveFloat* AddTranslationEasingCurve = nullptr;
